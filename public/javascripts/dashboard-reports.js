...
function getUrl(){
    ...
    //return "http://localhost:7080/bfr/v1/dashboard";
}
...
function loadDashboard(data){
    $('.count').text(data.attendance_data.present).css("color", "black");
    $('.count3').text(data.attendance_data.total).css("color", "black");
    $('.count4').text(data.attendance_data.percentage).css("color", "black");
